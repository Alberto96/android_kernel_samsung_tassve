...
#define LATEST_FW_VER_HW00   0x14 //TODO : 이부분을 0x0 으로 하면, SET_DOWNLOAD_BY_GPIO 1 이어도 동작하지 안함.
#define LATEST_FW_VER_HW01   0x13 //TODO : 이부분을 0x0 으로 하면, SET_DOWNLOAD_BY_GPIO 1 이어도 동작하지 안함.
...
static DEVICE_ATTR(tkey_rawcounter, S_IRUGO | S_IWUSR |S_IWOTH| S_IXOTH, tkey_rawcounter_show, tkey_rawcounter_store);
#else
