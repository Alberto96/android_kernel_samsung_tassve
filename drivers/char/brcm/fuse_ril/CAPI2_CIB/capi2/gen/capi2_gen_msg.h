...
typedef struct
{
	MS_MN_CB_MSG_IDS  *cbmi;
	MS_MN_CB_LANGUAGES  *lang;
...
}CAPI2_MsDbApi_SYS_EnableCellInfoMsg_Req_t;
...
typedef struct
{
	PDP_PDPDeactivate_Ind_t	*val;
}CAPI2_PDP_DEACTIVATION_IND_Rsp_t;

typedef struct
{
	PDP_PDPDeactivate_Ind_t	*val;
}CAPI2_PDP_PPP_SENDCLOSE_IND_Rsp_t;
...
}CAPI2_NetRegApi_SetTZUpdateMode_Req_t;
...
}CAPI2_SS_CALL_FORWARD_STATUS_RSP_Rsp_t;
...
bool_t xdr_CAPI2_MsDbApi_SYS_EnableCellInfoMsg_Req_t(void* xdrs, CAPI2_MsDbApi_SYS_EnableCellInfoMsg_Req_t *rsp);
...
bool_t xdr_CAPI2_PDP_PPP_SENDCLOSE_IND_Rsp_t(void* xdrs, CAPI2_PDP_PPP_SENDCLOSE_IND_Rsp_t *rsp);
