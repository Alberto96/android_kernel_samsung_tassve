...
#define MAX_CC_GET_ELEM_SIZE  168
...
void GenGetPayloadInfo(void* dataBuf, MsgType_t msgType, void** ppBuf, UInt32* len)
{
	...
	{
		CAPI2_PDP_PPP_SENDCLOSE_IND_Rsp_t* pVal = (CAPI2_PDP_PPP_SENDCLOSE_IND_Rsp_t*)dataBuf;
		*ppBuf = (void*)(pVal->val);
		break;
	}
	...
	{
		CAPI2_SS_CALL_BARRING_STATUS_RSP_Rsp_t* pVal = (CAPI2_SS_CALL_BARRING_STATUS_RSP_Rsp_t*)dataBuf;
		*ppBuf = (void*)(pVal->val);
		break;
	}
